...
const longBioParagraphs = [
    ...
    "I originally started learning HTML and wrote my first webpage while in highschool, but left it behind when I joined the Army. I held a latent interest in Computer Science for a number of years, and in 2022 made the decision to return to school and restart my developing journey.",
    "This website is hosted on Amazon S3 via GitHub and GitHub Actions. It is a work in progress, and probably always will be, just like me. As I gain new skills, I will employ and hone them here.",
